...
create view all_book_details as select b.book_id ,d.* from books b join book_details d
  on b.book_name = d.book_name;


create view count_of_book as select b.book_name, count(b.book_name)
  as number_of_book from books b join book_details d on b.book_name = d.book_name
